package com.openComplex.app.DynamicalSystems.Pendulums.Pendulum;
...
public class Pend extends Applet implements Runnable, ActionListener {
    ...
    public void init() {
        ...
        pan.add(but_new);
        pan.add(cb_stop);
        pan.add(but_phi1_plus);
        pan.add(but_phi1_min);
        pan.add(but_phi2_plus);
        pan.add(but_phi2_min);
