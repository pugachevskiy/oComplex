 ...
 */
public class DeterministicChaosPanelView extends JPanel {
    private ActionListener listener = new MFrameListener();
    private static final String TWODOUBLEPENS = "2 Double-Pendulums";
    private static final List<String> BUTTONSCELLULAR = Arrays.asList(TWODOUBLEPENS);


    public DeterministicChaosPanelView() {
